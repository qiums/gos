...
return array(
	...
	'arcindex.cid' => array('type'=>'input:hidden', 'attr'=>'class="req-any minlength1 mselect" data-kname="catename"', 'search'=>'1', 'islist'=>'1', 'option'=>'u.category/data'),
	...
	'arcindex.begindate' => array('type'=>'input:text', 'attr'=>'class="req-date" readonly="readonly"', 'group'=>'1'),
	'arcindex.enddate' => array('type'=>'input:text', 'attr'=>'class="req-date" readonly="readonly"', 'group'=>'1'),
	...
	'arcindex.coverpic' => array('type'=>'input:file', 'islist'=>'1'),
	'arcindex.sortby' => array('type' => 'input:text', 'attr' =>'class="req-num" maxlength="5"', 'value'=>'0', 'group'=>'1', 'islist'=>'1'),
	'arcindex.keywords' => array('type'=>'input:text', 'attr'=>'class="req-any" maxlength="255"', 'group'=>'1'),
	'arcindex.description' => array('type'=>'textarea', 'attr'=>'rows=3', 'group'=>'1'),
