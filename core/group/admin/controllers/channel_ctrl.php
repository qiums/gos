...
class channel_controller extends common_controller{
	public function __construct() {
		...
		if ($this->vars['sub_menu']){
			if ('field' === gc('env.action')){
				//$this->vars['sub_menu']['channel/field?id='. $this->qdata['id']] = lang('form_label.channel_field');
				$this->vars['sub_menu']['channel/field#add'] = '[+]'.lang('form_label.channel_field_add');
			}else{
				$this->vars['sub_menu']['channel/index#add'] = '[+]'. lang('form_label.channel_add');
			}
		}		
	}
